function updateTimer() {
    ...
    const timerInterval = setInterval(() => {
        ...
        if (diff <= 0) {
            ...
            // Mevcut HTML içeriğini temizle ve "BAŞLADI" yazısını ekle
            timerContainer.innerHTML = '<div class="event-started">ETKİNLİK BAŞLADI!</div>';
            // CSS'de hizalamayı bozmamak için countdown sınıfının flex yapısını koruyoruz
